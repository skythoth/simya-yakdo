...
const PharmacyToggle = ({ isOpen, onClick }) => {
  return (
    <button
      ...
      transition-all duration-300 pointer-events-auto outline-none select-none overflow-hidden
    ...
    >
      ...
      <div className="flex items-center justify-center h-24">
        <span className="whitespace-nowrap text-[#1a1a2e] text-[12px] font-bold -rotate-90 origin-center select-none">
          약국 리스트 보기
        </span>
      </div>
    </button>
